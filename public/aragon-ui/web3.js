...
var ETHERSCAN_NETWORK_TYPES = new Map([['main', ''], ['dijets', ''], ['kovan', 'kovan.'], ['rinkeby', 'rinkeby.'], ['ropsten', 'ropsten.'], ['goerli', 'goerli.']]);
...
var BLOCK_EXPLORERS = {
  etherscan: function etherscan(_ref) {
    ...
    return "http://20.9.33.115:4000/".concat(typePart, "/").concat(value);
  }
};
/**
