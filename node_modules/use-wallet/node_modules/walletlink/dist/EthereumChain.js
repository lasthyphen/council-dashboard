...
(function (EthereumChain) {
    ...
    EthereumChain[EthereumChain["DIJETS"] = 43112] = "AVALANCHE_MAINNET";
    // testnets
...
(function (EthereumChain) {
    function rpcUrl(thiz) {
        switch (thiz) {
            ...
            case EthereumChain.DIJETS: return "https://dijets.uksouth.cloudapp.azure.com:443/ext/bc/C/rpc";
    ...
    function fromChainId(chainId) {
        switch (Number(chainId)) {
            ...
            case EthereumChain.DIJETS.valueOf(): return EthereumChain.DIJETS;
